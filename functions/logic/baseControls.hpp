...
#ifndef OKS_GOL_MISC_BASECONTROLS_HPP
#define OKS_GOL_MISC_BASECONTROLS_HPP
...
class RscMapControl
{
	...
	colorTracks[] = {1,0,0,0.5};
	colorRoads[] = {0,0,0,0.7};
	colorMainRoads[] = {0,0,0,0.7};
...
#endif // OKS_GOL_MISC_BASECONTROLS_HPP
