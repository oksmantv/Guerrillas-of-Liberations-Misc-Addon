/*
    [_value] call OKS_fnc_IncreaseMultiplier;
...
// Increase force, decrease response
...
if(_Debug) then {
    format["Increasing Multipliers by %1%% to %2%% (Force) & %3%% (Response)",_value, round (_forceMultiplier * 100), round (_responseMultiplier * 100)] spawn OKS_fnc_LogDebug;
};     