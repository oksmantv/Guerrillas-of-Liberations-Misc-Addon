...
private _applyRect = {
    ...
    // Compatibility: apply attributes both via marker entity AND via marker name string.
    // Older working versions used the name string; some Eden contexts behave differently.
...

    {
        ...
        _x set3DENAttribute ["size2", [_markerHalfDepthMeters, _markerHalfWidthMeters]];
        _x set3DENAttribute ["rotation", 0];
