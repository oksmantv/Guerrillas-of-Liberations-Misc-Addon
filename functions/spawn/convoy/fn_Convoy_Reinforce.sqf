...
private _SpawnResupplyCrateWithTask = {
	...
	private _BoxClass = "";
	private _BoxCode = {};
	private _RandomPlayer = selectRandom (AllPlayers - entities "HeadlessClient_F");
	Switch (side group _RandomPlayer) do
	{
		Case WEST: {
			_BoxCode = { [_this, "small_box", toLower str (side group _RandomPlayer)] call GW_Gear_Fnc_Handler; };
