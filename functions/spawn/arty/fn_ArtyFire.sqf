/*
	_null = [east,ArtyName,TargetObjectPosition,RoundsFired,RearmTime,ReloadTime] spawn OKS_fnc_ArtyFire;
	_null = [east,this,getMarkerPos "respawn_west",7,300,30] spawn OKS_fnc_ArtyFire;
	[east,this,getMarkerPos "respawn_west",10,300,30] spawn OKS_fnc_ArtyFire;
*/
