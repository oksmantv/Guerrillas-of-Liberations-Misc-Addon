...
[
    ...
    {true},
    {
        ...
        if(_FailedUnpack) then {
            systemChat format["Your inventory is full. Unpacked %1 HEAB rounds on ground.",(4 - _UnpackedRounds)];
        } else {
            systemChat format["You unpacked %1 HEAB rounds.",_UnpackedRounds];
        };
    },
    {
