...
[
    {
        ...
        private _actionName = "Unpacking HEAB Rounds...";	
        ...
        [
            ...
            {true},
            {
                ...
                if (_FailedUnpack) then {
                    systemChat format ["Unpacked HEAB: %1 to inventory, %2 on ground. %3.", _UnpackedRounds, (4 - _UnpackedRounds), _invSpaceStr];
                } else {
                    systemChat format ["You unpacked %1 HEAB rounds. %2.", _UnpackedRounds, _invSpaceStr];
                };
                if (_FailedUnpack) then {
