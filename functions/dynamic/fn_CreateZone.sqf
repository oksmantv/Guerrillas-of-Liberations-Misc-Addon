...
_MainTriggerIsRectangle = _MainTriggerArea select 3;
	...
	if(_MainTriggerIsRectangle) then {
		...
		if(_SplitTrigger) then {
			...
			_Section_NE_Marker = [_MainTrigger,_MainTriggerSizeA,_MainTriggerSizeB,45,_MainTriggerAngle,"colorGreen",[0.7,0.5,0.5],"RECTANGLE"] call OKS_fnc_CreateMarker;
			_Section_NE_Trigger = [_MainTrigger,_MainTriggerSizeA,_MainTriggerSizeB,45,_MainTriggerAngle,[0.7,0.25,1],_MainTriggerIsRectangle] call OKS_fnc_CreateTrigger;

			_Section_SE_Marker = [_MainTrigger,_MainTriggerSizeA,_MainTriggerSizeB,135,_MainTriggerAngle,"colorRed",[0.7,0.5,0.5],"RECTANGLE"] call OKS_fnc_CreateMarker;
			_Section_SE_Trigger = [_MainTrigger,_MainTriggerSizeA,_MainTriggerSizeB,135,_MainTriggerAngle,[0.7,0.25,1],_MainTriggerIsRectangle] call OKS_fnc_CreateTrigger;

			_Section_SW_Marker = [_MainTrigger,_MainTriggerSizeA,_MainTriggerSizeB,225,_MainTriggerAngle,"colorYellow",[0.7,0.5,0.5],"RECTANGLE"] call OKS_fnc_CreateMarker;
			_Section_SW_Trigger = [_MainTrigger,_MainTriggerSizeA,_MainTriggerSizeB,225,_MainTriggerAngle,[0.7,0.25,1],_MainTriggerIsRectangle] call OKS_fnc_CreateTrigger;

			_Section_NW_Marker = [_MainTrigger,_MainTriggerSizeA,_MainTriggerSizeB,315,_MainTriggerAngle,"colorBlue",[0.7,0.5,0.5],"RECTANGLE"] call OKS_fnc_CreateMarker;
			_Section_NW_Trigger = [_MainTrigger,_MainTriggerSizeA,_MainTriggerSizeB,315,_MainTriggerAngle,[0.7,0.5,0.5],_MainTriggerIsRectangle] call OKS_fnc_CreateTrigger;
		...
		if(_SplitTrigger) then {
			...
			_Section_NE_Marker = [_MainTrigger,_MainTriggerSizeA,_MainTriggerSizeB,45,_MainTriggerAngle,"colorGreen",[0.7,0.5,0.5],"ELLIPSE"] call OKS_fnc_CreateMarker;
			_Section_NE_Trigger = [_MainTrigger,_MainTriggerSizeA,_MainTriggerSizeB,45,_MainTriggerAngle,[0.7,0.5,0.5],_MainTriggerIsRectangle] call OKS_fnc_CreateTrigger;

			_Section_SE_Marker = [_MainTrigger,_MainTriggerSizeA,_MainTriggerSizeB,135,_MainTriggerAngle,"colorRed",[0.7,0.5,0.5],"ELLIPSE"] call OKS_fnc_CreateMarker;
			_Section_SE_Trigger = [_MainTrigger,_MainTriggerSizeA,_MainTriggerSizeB,135,_MainTriggerAngle,[0.7,0.5,0.5],_MainTriggerIsRectangle] call OKS_fnc_CreateTrigger;

			_Section_SW_Marker = [_MainTrigger,_MainTriggerSizeA,_MainTriggerSizeB,225,_MainTriggerAngle,"colorYellow",[0.7,0.5,0.5],"ELLIPSE"] call OKS_fnc_CreateMarker;
			_Section_SW_Trigger = [_MainTrigger,_MainTriggerSizeA,_MainTriggerSizeB,225,_MainTriggerAngle,[0.7,0.5,0.5],_MainTriggerIsRectangle] call OKS_fnc_CreateTrigger;

			_Section_NW_Marker = [_MainTrigger,_MainTriggerSizeA,_MainTriggerSizeB,315,_MainTriggerAngle,"colorBlue",[0.7,0.5,0.5],"ELLIPSE"] call OKS_fnc_CreateMarker;
			_Section_NW_Trigger = [_MainTrigger,_MainTriggerSizeA,_MainTriggerSizeB,315,_MainTriggerAngle,[0.7,0.5,0.5],_MainTriggerIsRectangle] call OKS_fnc_CreateTrigger;
		...
		if(_HuntbaseArray isNotEqualTo [0,0,0,0,0]) then {
			if(!isNil "NEKY_Hunt_HuntBase" && !isNil "NEKY_Airbase") then {
				[_MainTrigger,_Side,_HuntbaseArray] spawn OKS_fnc_Find_HuntBase;
			} else {
				if(_Debug_Variable) then {
		...
		if(_RoadblockCount > 0) then {
			[_MainTrigger,_RoadblockCount,_Side,_RoadblockTarmac,_RoadBlockPatrols,_RoadblockChance] spawn OKS_fnc_Find_RoadBlocks;
			sleep 30;
		};
		...
		if(_MortarCount > 0) then {
			For "_i" to (_MortarCount - 1) do {
				[_MainTrigger,_Side,_MortarPatrol] spawn OKS_fnc_Find_Mortars;
				sleep 10;
			};
		};
	...
	*/
	if(!isNil "OKS_fnc_Populate_StaticWeapons") then {
			[_MainTrigger,objNull,_Side] spawn OKS_fnc_Populate_StaticWeapons;
	};
	...
	if(_Condition) then {
		...
		if(_StaticNumber > 0) then {
			[_MainTrigger,_Side,_StaticNumber,_CreateObjective,_LocalPatrols] spawn OKS_fnc_Populate_Strongpoints;
		};
		...
		if(_PatrolNumber > 0) then {
			for "_i" to (_GroupPerTrigger - 1) do {
				{[_X,_PatrolSize,_MainTriggerSizeA * 0.5,_Side] spawn OKS_fnc_Patrol_Spawn; sleep 10;} foreach _SpawnTriggers
			};
		};
		sleep 20;
	};
	...
	if(_Objectives > 0) then {
		...
		For "_i" to (_Objectives - 1) do {
			...
			[_MainTrigger,_RandomObjective,300,_Side,_ObjectivePatrols] spawn OKS_fnc_CreateObjectives;
			sleep 15;
		};
	};
	...
	if(_WheeledCount > 0 ) then {
		...
		{[_X,_WheeledPerTrigger,_MainTriggerSizeA,"WHEELED",_Side] spawn OKS_fnc_Vehicle_Patrol; sleep 25;} foreach _SpawnTriggers;
	...
	if(_APCCount > 0 ) then {
		...
		{[_X,_APCPerTrigger,_MainTriggerSizeA,"APC",_Side] spawn OKS_fnc_Vehicle_Patrol; sleep 25;} foreach _SpawnTriggers;
		sleep (_APCCount * 5);
	};
	if(_Debug_Variable) then {
	...
	if(_TankCount > 0 ) then {
		...
		{[_X,_TankPerTrigger,_MainTriggerSizeA,"TANK",_Side] spawn OKS_fnc_Vehicle_Patrol; sleep 25;} foreach _SpawnTriggers;
		sleep (_TankCount * 5);
	};
