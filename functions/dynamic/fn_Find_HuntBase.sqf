/*
	[Trigger_1,EAST] spawn OKS_fnc_Find_HuntBase;
*/
...
_HuntSettings = [] call OKS_fnc_Dynamic_Hunt_Settings;
...
Private _FindAndSpawnHuntBase = {
	...
	*/
	...
	if(_Type != "HELICOPTER") then {
		...
		[_Base, _Spawn, _MainTrigger, _Waves, _Respawn,_Side,_Vehicles,_Refresh] spawn OKS_fnc_HuntBase;
	} else {
		[_Base,_Spawn, _MainTrigger,_Side,(selectRandom _Vehicles),"unload",[2,0.8]] spawn OKS_fncAirbase;
	};
