		/*
			[Position,30,EAST] spawn OKS_fnc_Populate_StaticWeapons;
			[GetPos Object,30,EAST] spawn OKS_fnc_Populate_StaticWeapons;


			[Trigger,0,EAST] spawn OKS_fnc_Populate_StaticWeapons;
			[Trigger_1,0,EAST] spawn OKS_fnc_Populate_StaticWeapons;
		*/
