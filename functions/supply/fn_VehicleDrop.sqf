//	[side, "heli type classname" (default mid size heli of said side), "Drop/Unload", ["spawn","target","despawn"], "box content script path" or code , Boolean (Vulnerable, true or false)] spawn OKS_fnc_VehicleDrop;
//
/////////////////
//	Parameters:
/////////////////
...
//	null = [blufor,"","drop",["spawn","target","despawn"],"Scripts\NEKY_Supply\Supply Box Templates\Resupply.sqf",false] spawn OKS_fnc_VehicleDrop;
//
...
["Script Running %1","NEKY_VehicleDrop.sqf"] spawn NEKY_SupplyDebug;
