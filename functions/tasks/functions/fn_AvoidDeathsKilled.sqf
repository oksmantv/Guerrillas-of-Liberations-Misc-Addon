//	["Variable"] Spawn OKS_fnc_AvoidCasualties_Killed;
//
//	1) "Variable". 										String
//		a) The variable name for the side.
//		b) Automatically named "OKS_fnc_AvoidCasualties_" followed by Side name. EAST, CIV, WEST, GUER.
//
...
[_SelectTask, "Failed", false] call OKS_fnc_SetTaskState;
[5 - _Count] Call _Code;
...
{
	Sleep 1;
	[_TaskName, "Failed", false] call OKS_fnc_SetTaskState;
};