	// OKS_Rescue_Friendly
	// [this] spawn OKS_fnc_MoveAI;
	// [this] remoteExec ["OKS_fnc_MoveAI",0];
...
_unit addAction ["<t color='#f6f211'>Move Soldier</t>",
	...
	true,		// hideOnUse
	"",			// shortcut
	"!(_this getVariable ['IsCarryingUnit',false]) && Alive _target && [_target] call ace_common_fnc_IsAwake",		// condition
	5,			// radius
	false,		// unconscious
	"",			// selection
	""			// memoryPoint
