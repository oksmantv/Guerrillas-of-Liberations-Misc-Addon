	// OKS_Rescue_Friendly
	// [[1241.42,2522.1,4],east,["lot","large","fatal"],nil] spawn OKS_fnc_Treat_Casualty
	// [getPosATL pos_1,east,["lot","large","fatal"],nil] spawn OKS_fnc_Treat_Casualty;
	// [casualty_1,east,["lot","large","fatal"],nil] spawn OKS_fnc_Treat_Casualty;
	...
	_Settings = [_Side] call OKS_fnc_Task_Setting;
	...
	private _TextStatus = "";
	[_Casualty,_Status] spawn OKS_fnc_MedicalDamage;
