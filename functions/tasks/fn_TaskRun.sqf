...
//
//	Examples:
//	[1, ["NeKy_Task1", ["Avoid causing any civilian casualties.", "Avoid Casualties"], CIVILIAN]] Spawn OKS_fnc_TaskRun;
//	[1, ["Somename", ["Avoid causing any AAF casualties", "Avoid Casualties"], INDEPENDENT]] Spawn OKS_fnc_TaskRun;
//	[1, ["Derpy_Task", ["Don't kill them civvies", "Avoid Killing Civilians"], CIVILIAN, {Params ["_SubTask"]; if (_SubTask == 2) then {SystemChat "Subtask 2 failed! You have killed 2 or more civilians!"}}]] Spawn OKS_fnc_TaskRun;
//
//	Notes:
...
//
//	Examples:
//	[7,["NEKY_Task7", ["Wait for the helicopter to arrive.","Wait"], "Extraction", "Wait", 120]] Spawn OKS_fnc_TaskRun;
//	[7,["NEKY_Task7", ["Defend FOB Windstorm from CSAT forces.","Defend"], [1412,4124,0], "Defend", "DEFENDED", { [[],{SystemChat "HQ: FOB Windstorm has been defended!"}] remoteExec ["BIS_FNC_CALL",0] } ]] Spawn OKS_fnc_TaskRun;
//
//	Notes:
...
// Call Function
Call Compile Format ["[_Params,_Notify] Spawn OKS_fnc_%1",_Function];