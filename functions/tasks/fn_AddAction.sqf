//	[This,"Name","Variable",false,true] call OKS_fnc_AddAction
//
...
///////////////
//
//	[This,"Take Notes","NEKY_NotesTaken",True,True] call OKS_fnc_AddAction
//	[Map,"Search Map","Map_Searched",False,true] call OKS_fnc_AddAction
//
//
//	Version 0.9
//	Made by NeKo-ArroW
