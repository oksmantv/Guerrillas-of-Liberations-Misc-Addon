//	[Object to Attach, Object to attach to, detach if main object is destroyed, detach if attached object is destroyed] call OKS_fnc_AttachTo;
//
...
//	Examples:
//
//	[This, Table1] call OKS_fnc_AttachTo;
//	[Pole, Car, true] call OKS_fnc_AttachTo;
//	[This, Car, true] call OKS_fnc_AttachTo;
//	[This, Car, true, true] call OKS_fnc_AttachTo;
//
//	Made by NeKo-ArroW
//	Version 1.0
