...
/*
	...
	[[artyStrike_1,artyStrike_2],"rhs_ammo_3of56",1,140,10,100,true,nil] spawn OKS_fnc_Fallback_Artillery;
	[[artyStrike_1,artyStrike_2],"rhs_ammo_3of56",1,140,10,100,true,"taskdefend"] spawn OKS_fnc_Fallback_Artillery;
*/
...
{
	[_X,_Munition,_DelayBetweenRounds,_AmountOfRounds,_MunitionSpread] spawn OKS_fnc_RandomArtillery;
} foreach _Targets;
